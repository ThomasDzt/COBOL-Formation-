      *Exercice : Lire 2 fichiers 'clients.txt' et 'num-commandes.txt', 
      *et afficher les commandes par client

       IDENTIFICATION DIVISION. 
       PROGRAM-ID. commandecli.
       AUTHOR. ThomasD.
      ...
      *Création de l'alias correspondant au fichier 'clients.txt' 
       SELECT FICHIER-CLIENT ASSIGN TO "clients.txt"

      *Lecture du fichier ligne par ligne
       ORGANIZATION IS LINE SEQUENTIAL.

      *Création de l'alias correspondant au fichier 'commandes.txt'
      ...
      *Description des fichiers créés (groupe de variables article et stock)
       ...
       FD FICHIER-CLIENT.
           01 F-LIGNE-CLIENT.
               05 F-LIGNE-CLIENT       PIC X(10).
               05 F-LIGNE-COMMANDE     PIC X(2).
